...
public class OwnEngine extends Engine {
    ...
    protected void init() {
        ...
        if (yksioArrivalProcess != null) {
            yksioArrivalProcess.generateNext();
        }
        if (kaksioArrivalProcess != null) {
            kaksioArrivalProcess.generateNext();
        }
        if (kolmioArrivalProcess != null) {
            kolmioArrivalProcess.generateNext();
        }
        if (nelioArrivalProcess != null) {
    ...
    public void setMixedCanAmountValue(int amount) {
        garbageShelter.addGarbageCan(GarbageCanType.MIXED, amount);
    }
    ...
    public void setPlasticCanAmountValue(int amount) {
        garbageShelter.addGarbageCan(GarbageCanType.PLASTIC, amount);
    }
    ...
    public void setGlassCanAmountValue(int amount) {
        garbageShelter.addGarbageCan(GarbageCanType.GLASS, amount);
    }
    ...
    public void setPaperCanAmountValue(int amount) {
        garbageShelter.addGarbageCan(GarbageCanType.CARDBOARD, amount);
    }
    ...
    public void setBioCanAmountValue(int amount) {
        garbageShelter.addGarbageCan(GarbageCanType.BIO, amount);
    }
    ...
    public void setMetalCanAmountValue(int amount) {
        garbageShelter.addGarbageCan(GarbageCanType.METAL, amount);
    }
